...
public final class Default {
    ...
    public static final String APPLICATION_HEADERS_CONTENT_SECURITY_POLICY = Strings.EMPTY;
    public static final String APPLICATION_HEADERS_FEATURE_POLICY = Strings.EMPTY;
    public static final String APPLICATION_HEADERS_REFERER_POLICY = "no-referrer";
    public static final String APPLICATION_HEADERS_SERVER = "Undertow";
    public static final String APPLICATION_HEADERS_X_CONTENT_TYPE_OPTIONS = "nosniff";
    public static final String APPLICATION_HEADERS_X_FRAME_OPTIONS = "DENY";
    public static final String APPLICATION_HEADERS_XSS_PROTECTION = "1";
    ...
    public static final String CONFIGURATION_FILE = "config.props";
    ...
    public static final String DEFAULT_TEMPLATES_DIR = "/templates/defaults/";
    public static final String ENCODING = "UTF-8";
    public static final String FILES_FOLDER = "files";
    public static final String FILES_PATH = "src/main/resources/files/";
    public static final String FILTER_METHOD = "execute";
    ...
    public static final String MODULE_CLASS = "app.Module";
