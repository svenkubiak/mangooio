...
public enum Required {
    ...
    COOKIE_NAME("cookie name can not be null"),
    COOKIE_VALUE("cookie value can not be null"),
    CRON("cron can no be null"),
    CRYPTO("crypto can not be null"),
    DATA("data can not be null"),
    DATE("date can not be null"),
    DOMAIN("domain can not be null"),
    ...
    SAME_SIZE_MODE("samieSiteMode can not be null"),
