          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><input id="filter" type="text" name="table_search" class="form-control float-left form-control-lg" placeholder="Start typing what you are looking for...">
              </div>
