...
If you don't want to use a cache the ehcache.xml file is optional, as long with
the logback.xml file. If you don't not provide a logback.xml file, the logback
...
The following method parameters are available in mangoo I/O controller methods by default
...
- see link:#14-filters[14. Filters] for more information on filters.
