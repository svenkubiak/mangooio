...
ConfigUtils.getApplicationPort();
----------------
...
This can of course also be set for prod and test mode.
...
The manager offers some convinent methods for postpone task into the background of
