...
public class Routes implements MangooRoutes {
    ...
    public void routify() {
        ...
        Router.mapWebSocket().withAuthentication().toUrl("/websocketauth").onClass(WebSocketController.class);
        
        Router.mapServerSentEvent().withAuthentication().toUrl("/sseauth");
